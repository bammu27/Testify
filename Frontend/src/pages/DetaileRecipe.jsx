...
const RecipeDetailPage = () => {
  ...
  const fetchRecipe = async () => {
    try {
      const response = await fetch(`https://testifyat.onrender.com/recipe/${id}`, {
        headers: {
  ...
  const fetchUser = async () => {
    try {
      ...
      const response = await fetch(`https://testifyat.onrender.com/user/${username}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      });
  ...
  const handleCommentSubmit = async () => {
    try {
      const response = await fetch(`https://testifyat.onrender.com/recipe/comment/${id}`, {
        method: 'PUT',
        headers: {
  ...
  const handleLike = async () => {
    try {
      const response = await fetch(`https://testifyat.onrender.com/recipe/like/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`
